...
test_messages: list[tuple[str, bytes, ResponseCode]] = [
    (
        ...
        'QUERY NOERROR 0x8670 - codecrafters.io IN A',
        b'\x86\x70\x01\x20\x00\x01\x00\x00\x00\x00\x00\x00\x0c\x63\x6f'
        b'\x64\x65\x63\x72\x61\x66\x74\x65\x72\x73\x02\x69\x6f\x00\x00'
        b'\x01\x00\x01',
        ResponseCode.FORMAT_ERROR
    ), (
        'QUERY NOERROR 0xefac - codecrafters.io IN A +edns (OPT)',
        ...
        'QUERY NOERROR 0x33d5 - codecrafters.io IN A +edns (OPT)',
        ...
        'IQUERY NOERROR 0x9a1e - codecrafters.io IN A',
